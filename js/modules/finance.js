...
export function renderFinSummary() {
    ...
    el.innerHTML =
        '<div class="fin-stat" style="cursor:pointer" style="cursor:pointer" onclick="openProjectedIncomeDash&&openProjectedIncomeDash()"><div class="fin-stat-icon" style="background:rgba(106,184,154,.1);color:var(--green)"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v16a2 2 0 0 0 2 2h16"/><path d="M7 16h.01"/><path d="M11 12h.01"/><path d="M15 8h.01"/><path d="M7 16v-3"/><path d="M11 12v-3"/><path d="M15 8v-3"/></svg></div><div><div class="fin-stat-value">' + fmtUi(projected) + '</div><div class="fin-stat-label" id="lbl-projected-income">' + t('projectedIncome') + '</div></div></div>' +
        '<div class="fin-stat" style="cursor:pointer" style="cursor:pointer" onclick="openActualIncomeDash&&openActualIncomeDash()"><div class="fin-stat-icon" style="background:rgba(232,168,56,.15);color:var(--accent)"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/></svg></div><div><div class="fin-stat-value">' + fmtUi(actual) + '</div><div class="fin-stat-label" id="lbl-actual-income">' + t('actualIncome') + '</div></div></div>' +
        '<div class="fin-stat" style="cursor:pointer" style="cursor:pointer" onclick="openExpensesDash&&openExpensesDash()"><div class="fin-stat-icon" style="background:rgba(212,85,85,.1);color:var(--red)"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 17 13.5 8.5 8.5 13.5 2 7"/><polyline points="16 17 22 17 22 11"/></svg></div><div><div class="fin-stat-value">' + fmtUi(totalExp) + '</div><div class="fin-stat-label" id="lbl-total-expenses">' + t('totalExpenses') + '</div></div></div>' +
        '<div class="fin-stat" style="cursor:pointer" style="cursor:pointer" onclick="openNetProfitDash&&openNetProfitDash()"><div class="fin-stat-icon" style="background:rgba(176,154,218,.1);color:var(--purple)"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v16a2 2 0 0 0 2 2h16"/><path d="m19 9-5 5-4-4-3 3"/></svg></div><div><div class="fin-stat-value" style="color:' + netColor + '">' + fmtUi(net) + '</div><div class="fin-stat-label" id="lbl-net-profit">' + t('netProfit') + '</div></div></div>';
}
